...
public class A02_First_missing_positive {
   ...
   * - Now loop in array to check for first item in array which is positive, if found ans is 'indexOf(positive_item)+1' is the missing min positive
