...
public class A_01_ShortestPathUndirected {
   ...
   * - We know that with BFS traversal, we first reach any node in shortest possible distance for given source (FOR undirected)
