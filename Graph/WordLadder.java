 ...
 *    - Change the each charector of curWord, from a-z and form a newWord
 *    - First check if this new word matches endWork, if yes, return length+1 (length here descripts number of times queue become empty)
    ...
    while (!queue.isEmpty()) {
      ...
      for (int i = 0; i < qSize; i++) {
        ...
        for (int j = 0; j < wordLen; j++) {
          ...
          // change the each charector from a to z, and check if it matches with any word
          // in word list
