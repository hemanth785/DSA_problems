...
public class A09_KokoEatingBananas {
  /*
   * Approach: Using binary search (Efficient) - O(n * log(n)), it's not log(n) because, for each k value, we need to loop through entire array for calculating total hours
