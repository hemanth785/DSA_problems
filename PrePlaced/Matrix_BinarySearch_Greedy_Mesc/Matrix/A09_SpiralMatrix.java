...
public class A09_SpiralMatrix {
   ...
   * - traverse the matrix starting from [0,0], through boundary in all 4 directions, while adding items to arrayList
   * - while traversing keep checking for conditon (top <= bottom && left <= right)
